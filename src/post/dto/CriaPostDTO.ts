...
export class CriaPostDTO {
  ...
  @ApiProperty({
    ...
    example:
      'Nesta aula vamos aprender os conceitos fundamentais da matemática, incluindo operações básicas, frações e números decimais...',
    minLength: 10,
    maxLength: 5000,
  })
  ...
  @MaxLength(5000, {
    message: 'O conteúdo não pode ter mais de 5000 caracteres',
  })
  conteudo: string;
}
